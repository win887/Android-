...
public class NoteEditor extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case FONT_10: mText.setTextSize(10 * 2);	break;
            case FONT_16: mText.setTextSize(16 * 2); break;
            case FONT_20: mText.setTextSize(20 * 2); break;
            case FONT_RED: mText.setTextColor(getResources().getColor(R.color.colorRed)); break;
            case FONT_DARK: mText.setTextColor(getResources().getColor(R.color.colorDark)); break;
        case R.id.menu_save:
            String text = mText.getText().toString();
            updateNote(text, null);
            finish();
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        //values.put(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE, System.currentTimeMillis());//从系统获得当前时间
        //将系统获得的时间转为日期格式再次赋予
